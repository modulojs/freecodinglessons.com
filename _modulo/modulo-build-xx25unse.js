...
window.moduloBuild.modules["x1f2h736"] = function library1_LessonPage_staticdata (modulo) {
...
window.moduloBuild.modules["x1g3qjgj"] = function library1_configuration (modulo) {
...
//# sourceMappingURL=showdown.min.js.map
    ...
    function setupEditorURL() {
        ...
        if (myPath.includes('/') && (myPath.lastIndexOf('/') !== (myPath.length - 1))) {
            editorURL += myPath.substr(0, myPath.lastIndexOf('/')); // Get base path
        }
    }
    setupEditorURL();
...
window.moduloBuild.nameToHash = {
 "library1_configuration": "x1g3qjgj",
 ...
 "library1_LessonPage_staticdata": "x1f2h736",
